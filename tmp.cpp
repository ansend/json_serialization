...
__attribute__ ((__noreturn__)) void throwRuntimeError(std::string const& msg);

__attribute__ ((__noreturn__)) void throwLogicError(std::string const& msg);
...
protected:
 ...
 virtual CJsonObjectBase* GenerateJsonObjForDeSerialize(const string& propertyName){ return 
# 177 "json_serialize.h" 3 4
                                                                                           __null
# 177 "json_serialize.h"
                                                                                               ;}
 ...
 bool DoArrayDeSerialize(const string& propertyName, void* addr, Json::Value& root, CEnumJsonTypeMap listType, CEnumJsonTypeMap paramType)
 {
  if (listType == asVectorArray)
  {
   ...
   case asJsonObj:
    {
     return DoObjArrayDeSerialize<vector<CJsonObjectBase*> >(propertyName, addr, root);
    }
    break;
   case asBool:
    ...
    break;
   case asInt:
    return DoArrayDeSerialize<vector<int32_t>, int32_t>(addr, root);
   case asUInt:
    return DoArrayDeSerialize<vector<uint32_t>, uint32_t>(addr, root);
   case asInt64:
    return DoArrayDeSerialize<vector<int64_t>, int64_t>(addr, root);
   case asUInt64:
    return DoArrayDeSerialize<vector<uint64_t>, uint64_t>(addr, root);
   case asString:
    return DoArrayDeSerialize<vector<string>, string>(addr, root);
   default:
    break;
   }
  }
  else if(listType == asListArray)
  {
   ...
   case asJsonObj:
    {
     return DoObjArrayDeSerialize<list<CJsonObjectBase*> >(propertyName, addr, root);
    }
    break;
   case asBool:
    return DoArrayDeSerialize<list<bool>, bool>(addr, root);
   case asInt:
    return DoArrayDeSerialize<list<int32_t>, int32_t>(addr, root);
    case asUInt:
    return DoArrayDeSerialize<list<uint32_t>, uint32_t>(addr, root);
    case asInt64:
     return DoArrayDeSerialize<list<int64_t>, int64_t>(addr, root);
   case asUInt64:
     return DoArrayDeSerialize<list<uint64_t>, uint64_t>(addr, root);
   case asString:
    return DoArrayDeSerialize<list<string>, string>(addr, root);
   default:
    break;
   }
  }
 ...
 Json::Value CJsonObjectBase::DoArraySerialize(void* addr, CEnumJsonTypeMap listType, CEnumJsonTypeMap paramType)
 {
  if (listType == asVectorArray)
  {
   ...
   case asBool:
    return "";
   case asJsonObj:
    return DoArraySerialize((vector<CJsonObjectBase*>*)addr);
   case asInt:
    return DoArraySerialize((vector<int32_t>*)addr);
   case asUInt:
    return DoArraySerialize((vector<uint32_t>*)addr);
   case asInt64:

    return DoArraySerialize((vector<Json::Int64>*)addr);
   case asUInt64:

    return DoArraySerialize((vector<Json::UInt64>*)addr);
   case asString:
  ...
  else
  {
   ...
   case asJsonObj:
    return DoArraySerialize((list<CJsonObjectBase*>*)addr);
   case asInt:
    return DoArraySerialize((list<int32_t>*)addr);
   case asUInt:
    return DoArraySerialize((list<uint32_t>*)addr);
   case asInt64:
